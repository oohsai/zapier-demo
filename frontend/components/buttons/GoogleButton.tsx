...
export const GoogleButton = ({ children, onClick }: { children: ReactNode, onClick: () => void }) => {
    return <div className="flex justify-center rounded-full border font-semibold border-black px-2 py-2 cursor-pointer hover:bg-slate-100 font-light text-sm" onClick={onClick}>
